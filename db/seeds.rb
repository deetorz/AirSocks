...
Sock.create(name: "black ankle socks", description: "Comfy black ankle socks", color: "black", style: "ankle socks", size: 23.5, price: 500, user_id: 1, photo_url: "https://images.smartwool.com/is/image/SmartWool/SW004039001-1-p?$WC-FULLIMAGE$")
Sock.create(name: "Nice sporty socks", description: "Real men wear grey socks!", color: "grey", style: "sport socks", size: 33.5, price: 2800, user_id: 1, photo_url: "https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/68c250f2-451a-47d4-a5be-de7cc13dd82a/everyday-cushioned-training-ankle-socks-3-pairs-nGq57w.png")
